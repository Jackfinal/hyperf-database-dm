...
use Hyperf\Database\Dm\Query\Grammars\DmGrammar as QueryGrammar;
use Hyperf\Database\Dm\Query\Processors\DmProcessor as Processor;
use Hyperf\Database\Dm\Query\DmBuilder as QueryBuilder;
use Hyperf\Database\Dm\Schema\Grammars\DmGrammar as SchemaGrammar;
use Hyperf\Database\Dm\Schema\DmBuilder as SchemaBuilder;
...
class DmConnection extends Connection
{
     ...
     *
     * @return \Hyperf\Database\Grammar|\Yajra\Oci8\Query\Grammars\OracleGrammar
     */
     ...
     *
     * @param  \Hyperf\Database\Grammar|\Yajra\Oci8\Query\Grammars\OracleGrammar|\Yajra\Oci8\Schema\Grammars\OracleGrammar  $grammar
     ...
     *
     * @return \Hyperf\Database\Grammar|\Yajra\Oci8\Schema\Grammars\OracleGrammar
     */

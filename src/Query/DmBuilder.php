...
namespace Hyperf\Database\Dm\Query;
...
use Hyperf\Database\Dm\Exception\InvalidArgumentException;
...
class DmBuilder extends Builder
{
     ...
     * @param  bool  $not
     * @return \Hyperf\Database\Query\Builder|\Yajra\Oci8\Query\OracleBuilder
     */
